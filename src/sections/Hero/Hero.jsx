...
import CV from "../../assets/james-green-cv.pdf";
    ...
    <section id="hero" className={styles.container}>
      ...
      <div className={styles.info}>
        ...
        <span>
          ...
          <a
            href="https://www.linkedin.com/in/james-green-b1b73a114/"
            target="_blank"
          >
        ...
        <p className={styles.description}>
          With a passion for developing intuitive interfaces, making complex
          ideas simple and easier for people's lives.
        </p>
        <a href={CV} download>
